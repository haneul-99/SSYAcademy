...
<style>
	...
	table td:nth-child(2) { width: 80px; text-align: center; }
	table td:nth-child(3) { width: auto; }
	table td:nth-child(4) { width: 100px; text-align: center; }
	table td:nth-child(5) { width: 80px; text-align: center; }
	table td:nth-child(6) { width: 100px; text-align: center; }
