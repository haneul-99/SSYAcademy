		...
		<div class="col-md-6 col-md-offset-3">
			<div class="panel panel-login">
				<div class="panel-heading">
					<div class="row">
						<div class="col-xs-6">
						<a class="active" id="login-form-link" style="margin-bottom: 30px;">학원 비밀번호 변경</a>
						</div>
						
						<form action="/academy/account/acpwreset" method="POST">
							<input type="password" id="newpw" name="newpw" placeholder="새 비밀번호">
							<input type="password" id="newpwok" name="newpw" placeholder="새 비밀번호 확인">
							<input type="hidden" name="acid" value="${acdto.aid}">
