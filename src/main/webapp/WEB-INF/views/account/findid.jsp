		...
		<div class="col-md-6 col-md-offset-3">
			<div class="panel panel-login">
				...
				<div class="panel-body">
					<div class="row">
						<div class="col-lg-12">
							<form id="login-form" action="/academy/account/findidok" method="POST"
								style="display: block;">
							...
							<form id="register-form" action="/academy/account/findidok" method="POST"
								style="display: none;">
								...
								<div class="form-group">
									<input type="text" name="email" id="email"
										tabindex="2" class="form-control" placeholder="email" value="">
								</div>
								<div class="form-group">
									<div class="row">
										<div class="col-sm-6 col-sm-offset-3">
											<input type="submit" name="register-submit"
												...
												class="form-control btn btn-register" value="찾기">
										</div>
									</div>
								</div>
